...
public:
  ...
  VkResult vkGetPhysicalDevicePresentRectanglesKHX(VkSurfaceKHR surface, uint32_t* pRectCount, VkRect2D* pRects) const;
...
public:
  ...
  VkResult vkBindBufferMemory2KHX(uint32_t bindInfoCount, const VkBindBufferMemoryInfoKHX* pBindInfos) const;
  VkResult vkBindImageMemory2KHX(uint32_t bindInfoCount, const VkBindImageMemoryInfoKHX* pBindInfos) const;
  VkResult vkGetDeviceGroupPresentCapabilitiesKHX(VkDeviceGroupPresentCapabilitiesKHX* pDeviceGroupPresentCapabilities) const;
  VkResult vkGetDeviceGroupSurfacePresentModesKHX(VkSurfaceKHR surface, VkDeviceGroupPresentModeFlagsKHX* pModes) const;
  VkResult vkAcquireNextImage2KHX(const VkAcquireNextImageInfoKHX* pAcquireInfo, uint32_t* pImageIndex) const;
